...
public class Command {
	...
	/**
	 * 字符设置命令 - Character setting command
	 */
	//设置字符右间距
	...
	//设置汉字左右间距 - spacing for chinese characters
	 ...
	 * 格式设置指令
	 */
	//设置默认行间距  - set default line spacing
